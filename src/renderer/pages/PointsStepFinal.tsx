      ...
      <div className="w-full max-w-3xl bg-white dark:bg-gray-900 border border-green-200 dark:border-gray-700 rounded-3xl shadow-2xl overflow-hidden animate-fade-in relative">
        ...
        <div className="px-5 sm:px-8 pt-14 pb-6">
          ...
          <div className="flex flex-col items-center gap-3 sm:gap-4 mb-6 text-center">
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-950/40 text-green-700 dark:text-green-300 text-sm sm:text-base">
            ...
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 text-gray-700 dark:text-gray-200 text-xs sm:text-sm">
